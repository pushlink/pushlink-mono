...
namespace Com.Pushlink.Android {
	...
	public sealed partial class NinjaStrategy : global::Com.Pushlink.Android.Strategy {
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.pushlink.android']/class[@name='NinjaStrategy']/method[@name='notifyUser' and count(parameter)=4 and parameter[1][@type='android.content.Intent'] and parameter[2][@type='android.content.Context'] and parameter[3][@type='int'] and parameter[4][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.pushlink.android']/class[@name='NinjaStrategy']/method[@name='remind' and count(parameter)=0]"
		[Register ("remind", "()Z", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.pushlink.android']/class[@name='NinjaStrategy']/method[@name='unNotifyUser' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
