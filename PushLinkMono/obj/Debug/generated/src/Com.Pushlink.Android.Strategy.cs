		...
		protected virtual bool IsAnnoyingPopUpStrategy {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, id_isAnnoyingPopUpStrategy);
			}
		}
		...
		protected virtual bool IsFriendlyPopUpStrategy {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, id_isFriendlyPopUpStrategy);
			}
		}
		...
		protected virtual bool IsStatusBarStrategy {
			...
			get {
				...
				if (GetType () == ThresholdType)
					...
					return JNIEnv.CallNonvirtualBooleanMethod  (Handle, ThresholdClass, id_isStatusBarStrategy);
			}
		}
